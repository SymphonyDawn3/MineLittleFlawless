...
public class TrixiebelleJesterModel extends AdultAndBabyPonyModel<Trixiebelle> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		body.addOrReplaceChild("ruff", CubeListBuilder.create().texOffs(0, 28).addBox(-4.0F, -1.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.25F, -7.5F));
		...
		jingalings.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 14).addBox(-5.0F, -7.25F, -3.75F, 5.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		jingalings.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(28, 4).addBox(4.0F, -5.75F, 5.25F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
