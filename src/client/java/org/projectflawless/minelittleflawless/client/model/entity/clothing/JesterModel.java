...
public class JesterModel extends AdultAndBabyPonyModel<Arinos> {
	...
	public JesterModel(ModelPart root) {
		...
		this.rightArmSock = socks.getChild("rightArmSock");
		this.leftLegSock = socks.getChild("leftLegSock");
		this.leftArmSock = socks.getChild("leftArmSock");
		this.rightLegSock = socks.getChild("rightLegSock");
	...
	public static LayerDefinition createBodyLayer() {
		...
		body.addOrReplaceChild("jester", CubeListBuilder.create().texOffs(0, 34).addBox(-4.0F, -1.3333F, -9.3333F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.3F))
		...
		bowtie.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(24, 50).addBox(-1.0F, -3.0F, 0.7167F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 3.0F, -11.0F, 0.0F, 0.0F, -0.4363F));

		bowtie.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(32, 50).addBox(-2.0F, -3.0F, 0.7167F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 3.0F, -11.0F, 0.0F, 0.0F, 0.4363F));

		PartDefinition socks = body.addOrReplaceChild("socks", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		socks.addOrReplaceChild("rightArmSock", CubeListBuilder.create().texOffs(24, 34).addBox(0.0F, 4.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 2.6667F, -5.3333F));

		socks.addOrReplaceChild("leftLegSock", CubeListBuilder.create().texOffs(40, 0).addBox(-4.0F, 4.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 2.6667F, 3.6667F));

		socks.addOrReplaceChild("leftArmSock", CubeListBuilder.create().texOffs(40, 34).addBox(-4.0F, 4.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 2.6667F, -5.3333F));

		socks.addOrReplaceChild("rightLegSock", CubeListBuilder.create().texOffs(0, 46).addBox(0.0F, 4.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 2.6667F, 3.6667F));
		...
		jingalings.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(28, 20).addBox(-5.0F, -7.25F, -3.75F, 5.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		jingalings.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(46, 16).addBox(4.0F, -5.75F, 5.25F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
