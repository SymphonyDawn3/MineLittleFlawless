...
public class FarmerModel extends AdultAndBabyPonyModel<Flawless> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MineLittleFlawless.MOD_ID, "farmer_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		body.addOrReplaceChild("shirt", CubeListBuilder.create().texOffs(40, 33).addBox(-4.0F, -1.3333F, -9.3333F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.25F))
		...
		head.addOrReplaceChild("strawHat", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, 0.0F, -8.0F, 16.0F, 1.0F, 16.0F, new CubeDeformation(0.0F))
		...
		head.addOrReplaceChild("hatStrap", CubeListBuilder.create().texOffs(40, 17).addBox(-4.0F, -6.0F, -6.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.25F))
