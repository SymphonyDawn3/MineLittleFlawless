...
@EventBusSubscriber
public class Trixie extends TamableAnimal {
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(8, new TemptGoal(this, 1, itemstack -> itemstack.is(Items.BEETROOT), false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        Trixie retval = MineLittleFlawlessEntities.TRIXIE.get().create(serverWorld, null, ageable.blockPosition(), MobSpawnType.BREEDING, false, false);
        if (retval != null) {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        event.put(MineLittleFlawlessEntities.TRIXIE.get(), createAttributes().build());
    }
}
