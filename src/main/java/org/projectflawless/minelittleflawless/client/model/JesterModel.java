...
public class JesterModel extends AgeableHierarchicalModel<Arinos> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MineLittleFlawless.MODID, "jester_model"), "main");
