...
public class ModelFlawless extends EntityModel<LivingEntityRenderState> {
	...
	public final ModelPart Realhat;
	...
	public final ModelPart neckFix;
	public final ModelPart neckFix2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Realhat = head.addOrReplaceChild("Realhat", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 2.0F));
		PartDefinition cube_r1 = Realhat.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -2.0F, 0.0F, 10.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -5.0F, -6.0F, -0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r2 = Realhat.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(32, 45).addBox(-8.0F, -8.0F, 1.0F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition neckFix = neck.addOrReplaceChild("neckFix", CubeListBuilder.create(), PartPose.offset(0.0F, -1.0F, -2.0F));
		PartDefinition neckFix2 = neckFix.addOrReplaceChild("neckFix2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1571F, 0.0F, 0.0F));
