...
public class ArinosModel extends AgeableHierarchicalModel<Arinos> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("minelittleflawless", "arinos_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition stallion = snout.addOrReplaceChild("stallion", CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, -1.0F, -7.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition wings = body.addOrReplaceChild("wings", CubeListBuilder.create(), PartPose.offset(0.0F, -5.3333F, -7.3333F));

		PartDefinition rightWing = wings.addOrReplaceChild("rightWing", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition foldedRight = rightWing.addOrReplaceChild("foldedRight", CubeListBuilder.create().texOffs(52, 60).addBox(4.001F, 5.0F, 1.999F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(56, 36).addBox(4.001F, 5.0F, 4.001F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(52, 60).addBox(4.001F, 5.0F, 6.002F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 13.0F, -2.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition extendedRight = rightWing.addOrReplaceChild("extendedRight", CubeListBuilder.create().texOffs(40, 60).addBox(-0.5F, 6.0F, 0.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.1F))
		.texOffs(14, 64).addBox(-0.5F, 0.0F, -0.2F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(4.5F, 5.3F, 6.0F, -0.5236F, -3.1416F, -2.5307F));
		...
		.texOffs(60, 60).addBox(-0.5F, -1.0F, -0.3F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8378F, 0.0F, 0.0F));

		PartDefinition feather4_r1 = extendedRight.addOrReplaceChild("feather4_r1", CubeListBuilder.create().texOffs(60, 60).addBox(-0.5F, 5.0F, 2.0F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4887F, 0.0F, 0.0F));

		PartDefinition feather3_r1 = extendedRight.addOrReplaceChild("feather3_r1", CubeListBuilder.create().texOffs(60, 60).addBox(-0.5F, 1.8F, 1.3F, 1.0F, 8.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.733F, 0.0F, 0.0F));

		PartDefinition leftWing = wings.addOrReplaceChild("leftWing", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition foldedLeft = leftWing.addOrReplaceChild("foldedLeft", CubeListBuilder.create().texOffs(0, 64).addBox(-6.1F, 5.0F, 1.999F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(32, 60).addBox(-6.1F, 5.0F, 4.001F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 64).addBox(-6.1F, 5.0F, 6.002F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 13.0F, -2.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition extendedLeft = leftWing.addOrReplaceChild("extendedLeft", CubeListBuilder.create().texOffs(46, 60).addBox(-0.5F, 6.0F, 0.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.1F))
		.texOffs(64, 16).addBox(-0.5F, 0.0F, -0.2F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(-4.5F, 5.3F, 6.0F, -0.5236F, -3.1416F, 2.5307F));
		...
		.texOffs(8, 64).addBox(-0.5F, -1.0F, -0.3F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8378F, 0.0F, 0.0F));

		PartDefinition feather4_r2 = extendedLeft.addOrReplaceChild("feather4_r2", CubeListBuilder.create().texOffs(8, 64).addBox(-0.5F, 5.0F, 2.0F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4887F, 0.0F, 0.0F));

		PartDefinition feather3_r2 = extendedLeft.addOrReplaceChild("feather3_r2", CubeListBuilder.create().texOffs(8, 64).addBox(-0.5F, 1.8F, 1.3F, 1.0F, 8.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.733F, 0.0F, 0.0F));
