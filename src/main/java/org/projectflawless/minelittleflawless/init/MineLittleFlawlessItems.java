...
public class MineLittleFlawlessItems {
    ...
    public static final DeferredItem<SpawnEggItem> FLAWLESS_SPAWN_EGG = register("flawless_spawn_egg", properties -> new SpawnEggItem(MineLittleFlawlessEntities.FLAWLESS.get(), 10205183, 10205183, properties));
