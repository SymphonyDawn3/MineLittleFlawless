...
public class MineLittleFlawlessItems {
    ...
    public static final SpawnEggItem WISH_FULFILLMENT_SPAWN_EGG = register("wish_fulfillment_spawn_egg", () -> new SpawnEggItem(MineLittleFlawlessEntities.WISH_FULFILLMENT, 0x6bb3d0, 0x3c285f, new Item.Properties()));
